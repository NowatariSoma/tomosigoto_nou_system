...
class TestAccountSettingService:
    ...
    def setup_method(self):
        ...
        self.mock_department_repo = Mock()
    ...
    def test_get_profile_by_user_id_success(self):
        ...
        result = self.service.get_profile_by_user_id(user_id)
    ...
    def test_get_profile_by_user_id_not_found(self):
        ...
        result = self.service.get_profile_by_user_id(str(uuid4()))

        assert result is None

    def test_get_profile_by_user_id_fallback_department(self):
    ...
    def test_create_profile_success(self):
        ...
        result = self.service.create_profile(user_id, profile_create)

        assert result.student_id == "S12345678"
        self.mock_profile_repo.create_profile.assert_called_once()

    def test_create_profile_invalid_department(self):
        """プロフィール作成 - 無効な学部コード"""
        profile_create = AccountSettingProfileCreate(
            student_id="S12345678",
            first_name_kanji="太郎",
        ...
        with pytest.raises(APIException):
            self.service.create_profile(str(uuid4()), profile_create)

    def test_create_profile_duplicate_student_id(self):
        """プロフィール作成 - 学籍番号重複"""
        profile_create = AccountSettingProfileCreate(
            student_id="S12345678",
            first_name_kanji="太郎",
    ...
    def test_delete_profile_success(self):
        ...
        result = self.service.delete_profile(user_id)
    ...
    def test_validate_profile_data_valid(self):
        ...
        result = self.service.validate_profile_data(profile_data)

        assert result.is_valid is True
        assert len(result.errors) == 0

    def test_validate_profile_data_empty_student_id(self):
        """バリデーション - 空の学籍番号"""
    ...
    def test_validate_profile_data_short_student_id(self):
        """バリデーション - 短すぎる学籍番号"""
    ...
    def test_validate_profile_data_invalid_year(self):
        """バリデーション - 無効な学年"""
        profile_data = {"year": 7}
    ...
    def test_validate_profile_data_empty_name(self):
        """バリデーション - 空の名前"""
