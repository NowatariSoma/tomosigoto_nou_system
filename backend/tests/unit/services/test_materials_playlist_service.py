...
class TestMaterialsPlaylistService:
    ...
    async def test_get_playlist_by_id(self):
        ...
        result = await self.service.get_materials_playlist_by_id(playlist_id)
    ...
    async def test_create_playlist(self):
        ...
        result = await self.service.create_materials_playlist(data)
    ...
    async def test_update_playlist(self):
        ...
        result = await self.service.update_materials_playlist(playlist_id, data)
    ...
    async def test_delete_playlist(self):
        ...
        result = await self.service.delete_materials_playlist(playlist_id)
    ...
    async def test_search_playlists(self):
        ...
        result = await self.service.search_materials_playlists(title="検索")
