...
import { RightDrawerPersonDetail } from '~/pages/people/right-drawer/components/RightDrawerPersonDetail';
...
export function RightDrawerRouter() {
  ...
  switch (rightDrawerPage) {
    ...
    case RightDrawerPages.PersonDetail:
      return <RightDrawerPersonDetail />;
    default:
      return <></>;
  }
}
