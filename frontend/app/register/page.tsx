...
export default function RegisterPage() {
  ...
  const addRoom = () => {
    ...
    setSelectedRooms([
      ...selectedRooms,
      { id: newRoomNumber, name: newRoomNumber.toString() },
    ]);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="max-w-6xl mx-auto p-8 space-y-8">
            ...
            <div className="flex flex-wrap gap-3">
              {selectedRooms.map((room) => (
                <Badge
                  key={room.id}
                  variant="outline"
                  className="px-4 py-2 text-base border-2 border-blue-200 bg-blue-50 hover:bg-blue-100 transition-colors"
                >
                  <button
        ...
        <div className="flex justify-center gap-4 pt-8">
          <Button
            size="lg"
            className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-8 py-3 text-lg font-medium shadow-lg hover:shadow-xl transition-all"
          >
            予約を登録
          </Button>
          <Button
            variant="outline"
            size="lg"
            className="border-2 border-gray-300 hover:border-gray-400 px-8 py-3 text-lg font-medium"
          >
            キャンセル
          </Button>
        </div>
