...
import { useMemberAssignments } from '@/features/member_assignments-setting/hooks/useMemberAssignments';
...
vi.mock('@/features/member_assignments-setting/services/member-assignments-service', () => ({
