                ...
                {searchResults.length > 0 ? (
                  <div className="space-y-3 max-h-40 overflow-y-auto">
                    {searchResults.map((user) => (
                      <div
                        key={user.id}
                        className="flex items-center justify-between p-4 bg-white border-2 border-gray-200 rounded-lg hover:border-blue-400 focus-within:border-blue-500 transition-colors"
                      >
            ...
            <div className="bg-white border-2 border-green-200 rounded-lg p-4">
              ...
              <div className="space-y-3 max-h-40 overflow-y-auto">
                {selectedUsers.map((user, index) => (
                  <div key={user.id} className="flex items-center justify-between bg-white rounded-lg p-4 border-2 border-green-200 hover:border-green-300 transition-colors">
                    <div className="flex items-center gap-3">
                      <div className="flex items-center justify-center w-10 h-10 bg-green-600 text-white rounded-full text-sm font-bold">
                        {index + 1}
                      </div>
                      <div>
