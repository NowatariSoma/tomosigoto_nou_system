...
import { Edit, Eye, Plus, Calendar, ArrowLeft, Sparkles, Save, RotateCcw } from 'lucide-react';
...
export const PracticeScheduleEditorPage: React.FC<PracticeScheduleEditorPageProps> = ({
  ...
  const handleAddTimeSlot = () => {
    // hookのローカル処理を呼び出し（APIは保存ボタンで一括呼び出し）
    addTimeSlot();
  };
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3">
          ...
          <Button
            ...
            className={`flex items-center space-x-2 px-4 py-2 ${
              hasUnsavedChanges ? 'bg-red-600 hover:bg-red-700' : ''
            }`}
          >
