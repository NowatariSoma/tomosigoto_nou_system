...
// 特定のユースケース向けの専用モーダルを作成する際の例
export interface RoomItem extends SelectionModalItem {
  name: string;
  campus: string;
}

export const RoomSelectionModal: React.FC<{
  isOpen: boolean;
  onClose: () => void;
  onConfirm: (selectedRooms: RoomItem[]) => void;
  availableRooms: RoomItem[];
  currentlySelectedRooms: RoomItem[];
}> = ({
  isOpen,
  onClose,
  onConfirm,
