...
リモートSupabase直接: https://uilydqaqephxtcnnqihy.supabase.co
...
const SUPABASE_URL = 'https://uilydqaqephxtcnnqihy.supabase.co';
...
```http
### ログイン
POST https://uilydqaqephxtcnnqihy.supabase.co/auth/v1/token?grant_type=password
