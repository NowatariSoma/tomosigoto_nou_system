...
| エンドポイント | メソッド | 説明 | 権限 |
|--------------|--------|------|------|
| `/api/base-plans` | GET | 基本計画一覧取得 | Editor以上 |
| `/api/base-plans` | POST | 新規基本計画作成 | Editor以上 |
| `/api/base-plans/{id}` | GET | 特定基本計画取得 | Editor以上 |
| `/api/base-plans/{id}` | PUT | 基本計画更新 | Editor以上 |
| `/api/base-plans/{id}` | DELETE | 基本計画削除 | Admin |
| `/api/templates` | GET | テンプレート一覧取得 | Editor以上 |
| `/api/templates` | POST | 新規テンプレート作成 | Editor以上 |
| `/api/templates/{id}` | GET | 特定テンプレート取得 | Editor以上 |
| `/api/templates/{id}` | PUT | テンプレート更新 | Editor以上 |
| `/api/templates/{id}` | DELETE | テンプレート削除 | Admin |
| `/api/templates/{id}/validate` | POST | テンプレート検証 | Editor以上 |
| `/api/templates/categories` | GET | テンプレートカテゴリ取得 | Editor以上 |
| `/api/schedules` | GET | スケジュール一覧取得 | Viewer以上 |
| `/api/schedules` | POST | 新規スケジュール作成 | Editor以上 |
| `/api/schedules/generate` | POST | 基本計画からスケジュール生成 | Editor以上 |
